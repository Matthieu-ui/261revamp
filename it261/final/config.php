...
switch(THIS_PAGE) {
    ...
    $body = 'home';
    $headline = 'Welcome to Kerf World Wide Web Gallery';
    break;

    case 'about.php':
    $title = 'About page of final website';
    $body = 'about inner';
    $headline = 'About KWWWG';
    break;

    case 'switch.php':
    $title = 'Switch page of final website';
    $body = 'daily inner';
    $headline = 'Daily Featured Artwork';
    break;

    case 'products.php':
    $title = 'Gallery page of final website';
    $body = 'product inner';
